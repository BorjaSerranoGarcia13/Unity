...
public class rail : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        change =  GetComponentsInChildren<ChangeFocus>();
    ...
    public Vector3 ProjectedPositionOnRail(Vector3 pos)
    {
        int closestNodeIndex = GetClosestNode(pos);
        change[closestNodeIndex].ChangeCameraFocus();
        ...
        else
        {
            ...
            else
            {
                ...
                Debug.DrawLine(pos, leftSeg, Color.green);
